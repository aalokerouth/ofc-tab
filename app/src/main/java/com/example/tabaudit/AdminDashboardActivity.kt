...
class AdminDashboardActivity : AppCompatActivity() {
    ...
    private fun populateUI(data: AdminStats) {
        ...
        // 2. Populate ACTIVE LOANS (Who has tabs right now)
    ...
    private fun addTextToContainer(container: LinearLayout, content: String, isBold: Boolean, color: Int = Color.BLACK) {
